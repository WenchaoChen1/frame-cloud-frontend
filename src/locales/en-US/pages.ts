export default {
  ...
  'application':{
    'list': {
      ...
      'authorizationCodeValidity':'Authorization Code Validity',
      'deviceCodeValidity':'Device Code Validity',
      'idTokenSignatureAlgorithm':'OIDC ID Token Endpoint Authentication Signature Algorithm',
